...
def display(request):
    ss="<h2 style='color:blue;'><center>Hello User, Welcome to Django First-Project First-App,</center></h2><hr />";
    return HttpResponse(ss);
    
def show(request):
    ss = '''<!--
    HTML webpage to display "welcome-message" with different Headings
	(D:\Dileep K\HTML Files\Welcome.html)
-->
	<html>
	<head>
...
def demo(request):
    htmldata='''<center>
            <h1>Welcome Demo User same response</h1>
            <hr />
            <h2>This is Same-Output for diff-multiple-request-URL</h2>
            <hr />
